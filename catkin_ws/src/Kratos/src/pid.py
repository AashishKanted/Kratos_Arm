...
class PID():
    ...
    def _init_(self):
        ...
        #changes
        self.sub1=rospy.Subscriber('/encoder',Float32,self.gety)
        self.sub2 = rospy.Subscriber('inv_k',Float32,self.gettheta)
        self.pub=rospy.Publisher('pid_out',Float32,queue_size=10)
